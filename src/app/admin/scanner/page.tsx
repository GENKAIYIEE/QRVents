export default function ScannerPage() {
  return <ComingSoon icon="qr_code_scanner" title="Campus Scanner" desc="Full-screen QR code scanner with PIN-based lockscreen. Students present their QR code to record attendance automatically. Includes lock mode to prevent unauthorized access." color="#10B981" bg="#ECFDF5" />
}
  ...
  return (
    <div>
      ...
      <div style={{ background: "white", borderRadius: "20px", border: "1px solid #F1F5F9", boxShadow: "0 1px 4px rgba(0,0,0,0.05)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "80px 40px", textAlign: "center", minHeight: "500px" }}>
        ...
        <a href="/admin/dashboard" style={{ marginTop: "32px", display: "inline-flex", alignItems: "center", gap: "8px", background: "linear-gradient(135deg, #3B82F6, #1D4ED8)", color: "white", padding: "12px 24px", borderRadius: "10px", textDecoration: "none", fontWeight: 600, fontSize: "13px", boxShadow: "0 4px 15px rgba(59,130,246,0.35)" }}>
