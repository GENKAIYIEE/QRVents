export default function SettingsPage() {
  return <ComingSoon icon="settings" title="Settings" desc="Configure system-wide settings: update admin profile, change password, manage notification preferences, set scanner PIN policies, and configure email domains for student registration." color="#64748B" bg="#F8FAFC" />
}
