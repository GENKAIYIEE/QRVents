export default function AttendancePage() {
  return <ComingSoon icon="wifi_tethering" title="Live Attendance" desc="Real-time attendance monitoring with virtualized student lists for performance at scale. Filter by department, event, or year level. Updates instantly as students scan in." color="#8B5CF6" bg="#F5F3FF" />
}
