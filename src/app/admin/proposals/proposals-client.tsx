    ...
    <div className="flex flex-col gap-8 w-full max-w-full pb-10">
      ...
      <div>
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-blue-600/80 text-[10px] font-extrabold uppercase tracking-widest">Proposals</span>
        </div>
        <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight leading-none">Event Proposals</h1>
      </div>
