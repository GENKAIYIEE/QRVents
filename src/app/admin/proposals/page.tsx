export default function ProposalsPage() {
  return <ComingSoon icon="assignment" title="Event Proposals" desc="Review, approve, hold, or reject event proposals submitted by department administrators. Track proposal status across all departments." color="#F59E0B" bg="#FFFBEB" />
}
